        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-brand-cream/70 leading-relaxed">
              LJC Capital Consulting provides high-level coordination and strategic consulting across two primary pillars: Institutional Finance and Sustainable Technology.
            </p>
          </motion.div>
        </div>
      </section>
